...
if ($safe) {
    ...
    #looks like there is a lag sometimes between adding a doc and it being searchable. trying to work around this
    sleep 2;
	...
	foreach my $banedIps (@{$activeBanResult->{'aggregations'}->{'ipData'}->{'terms'}}) {
